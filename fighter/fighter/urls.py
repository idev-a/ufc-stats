...
urlpatterns = [
    ...
    path('api/entries/save/', views.EntryViewSet.as_view({'post': 'save_entries'}), name='latest_event'),
    path('api/entries/contest', views.EntryViewSet.as_view({'get': 'get_latestContest'}), name='latest_event'),
